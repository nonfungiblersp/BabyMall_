<footer class="bg-light theme1 position-relative">
          ...
          <div class="col-12 col-sm-6 col-lg-4 mb-30">
            <div class="footer-widget mx-w-400">
              <div class="footer-logo mb-25">
                <a href="/dashboard">
                  <img src="{{asset('userside')}}/assets/img/logo/BabyMall_logo.jpeg.png" width="85" height="85" alt="footer logo" />
                </a>
              </div>
              <p class="text mb-30">
               You can visit Our Social Media Pages
              </p>
              ...
              <div class="product-sync-init mb-20">
                <div class="single-product">
                  <div class="product-thumb">
                    <img
                      src="{{asset('userside')}}/assets/img/slider/thumb/1.jpg"
                      alt="product-thumb"
                    />
                  </div>
                </div>
                ...
                <div class="single-product">
                  <div class="product-thumb">
                    <img
                      src="{{asset('userside')}}/assets/img/slider/thumb/2.jpg"
                      alt="product-thumb"
                    />
                  </div>
                </div>
                ...
                <div class="single-product">
                  <div class="product-thumb">
                    <img
                      src="{{asset('userside')}}/assets/img/slider/thumb/3.jpg"
                      alt="product-thumb"
                    />
                  </div>
                </div>
                ...
                <div class="single-product">
                  <div class="product-thumb">
                    <img
                      src="{{asset('userside')}}/assets/img/slider/thumb/4.jpg"
                      alt="product-thumb"
                    />
                  </div>
                </div>
              ...
              <div class="product-sync-nav">
                <div class="single-product">
                  <div class="product-thumb">
                    <a href="javascript:void(0)">
                      <img
                        src="{{asset('userside')}}/assets/img/slider/thumb/1.1.jpg"
                        alt="product-thumb"
                    /></a>
                  </div>
                </div>
                ...
                <div class="single-product">
                  <div class="product-thumb">
                    <a href="javascript:void(0)">
                      <img
                        src="{{asset('userside')}}/assets/img/slider/thumb/2.1.jpg"
                        alt="product-thumb"
                    /></a>
                  </div>
                </div>
                ...
                <div class="single-product">
                  <div class="product-thumb">
                    <a href="javascript:void(0)"
                      ><img
                        src="{{asset('userside')}}/assets/img/slider/thumb/3.1.jpg"
                        alt="product-thumb"
                    /></a>
                  </div>
                </div>
                ...
                <div class="single-product">
                  <div class="product-thumb">
                    <a href="javascript:void(0)"
                      ><img
                        src="{{asset('userside')}}/assets/img/slider/thumb/4.1.jpg"
                        alt="product-thumb"
                    /></a>
                  </div>
                </div>
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-5 divide-right">
              <div class="row">
                <div class="col-md-6">
                  <img src="{{asset('userside')}}/assets/img/product/2.png" alt="img" />
                </div>
  ...
  <!-- Mirrored from htmldemo.net/looki/looki/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 07:12:00 GMT -->
  </html>
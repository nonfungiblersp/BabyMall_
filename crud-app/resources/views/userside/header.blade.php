...
<!-- Mirrored from htmldemo.net/looki/looki/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 07:11:58 GMT -->
<head>
    <meta charset="UTF-8" />
    ...
    ****************************-->
     ...
     ***********************************************-->
    <!-- <link rel="stylesheet" href="{{asset('userside')}}/assets/css/vendor/vendor.min.css" />
    <link rel="stylesheet" href="{{asset('userside')}}/assets/css/plugins/plugins.min.css" />
    <link rel="stylesheet" href="{{asset('userside')}}/assets/css/style.min.css" /> -->
</head>
    ...
    <div class="offcanvas-head mb-4">
      <nav class="offcanvas-top-nav">
        <ul class="d-flex flex-wrap">
          ...
          <li class="my-2 mx-2">
            <a href="compare.html"
              ><i class="ion-ios-loop-strong"></i> Compare <span>({{$order}})</span>
            </a>
          </li>
          <li class="my-2 mx-2">
          ...
          <ul class="offcanvas-submenu">
            ...
            <li>
              ...
              <ul class="offcanvas-submenu">
                ...
                <li><a href="/userside/cart">Cart Page</a></li>
    ...
    <ul class="minicart-product-list">
      <li>
        <a href="single-product.html" class="image"
          ><img src="{{asset('userside')}}/assets/img/mini-cart/4.png" alt="Cart product Image"
        /></a>
        <div class="content">
      ...
      <li>
        <a href="single-product.html" class="image"
          ><img src="{{asset('userside')}}/assets/img/mini-cart/5.png" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="single-product.html" class="title"
      ...
      <li>
        <a href="single-product.html" class="image"
          ><img src="{{asset('userside')}}/assets/img/mini-cart/6.png" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="single-product.html" class="title"
            >orginal Age Defying Cosmetics Makeup</a
...
<div id="offcanvas-cart" class="offcanvas offcanvas-cart theme1">
  <div class="inner">
    ...
    {{-- <ul class="minicart-product-list">
      <li>
        <a href="single-product.html" class="image"
          ><img src="{{asset('userside')}}/assets/img/mini-cart/1.png" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="single-product.html" class="title"
            >orginal Age Defying Cosmetics Makeup</a
      ...
      <li>
        <a href="single-product.html" class="image"
          ><img src="{{asset('userside')}}/assets/img/mini-cart/2.png" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="single-product.html" class="title"
            >On Trend Makeup and Beauty Cosmetics</a
      ...
      {{-- <li>
        <a href="single-product.html" class="image"
          ><img src="{{asset('userside')}}/assets/img/mini-cart/3.png" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="single-product.html" class="title"
            >orginal Age Defying Cosmetics Makeup</a
    ...
    {{-- <a
      href="/cart"
      class="btn btn-primary btn--lg d-block d-sm-inline-block me-sm-2"
      >view cart</a
    >
    <a
      href="checkout.html"
    ...
    <div class="container position-relative">
      <div class="row align-items-center">
        <div class="col-6 col-lg-3">
          <div class="logo">
            <a href="/dashboard"
              ><img height="100" width="100" class="img-rounded" src="{{asset('userside')}}/assets/img/logo/BabyMall_logo.jpeg.png" alt="logo"
            /></a>
          </div>
        </div>
        <div class="col-lg-6 d-none d-lg-block">
          <ul class="main-menu d-flex justify-content-center">
            ...
            <li class="position-static <?=$path=='shop'?'active':''?>">
              <a href="/shop"
                >Shop </a>
              {{-- <ul class="mega-menu row"> --}}
                ...
                {{-- <li class="col-6">
                  <ul> --}}
                    {{-- <li class="mega-menu-title"><a href="#">Shop By Product</a></li> --}}
                    {{-- <li><a href="shop-grid-list.html">Shop List</a></li>
                    <li>
                      <a href="shop-grid-list-left-sidebar.html"
                        >Shop List Left Sidebar</a
                ...
                {{-- <li class="col-6 mt-4"> --}}
                  {{-- <a href="single-product.html" class="zoom-in overflow-hidden" --}}
                    {{-- ><img src="{{asset('userside')}}/assets/img/mega-menu/1.png" alt="img"
                  /></a> --}}
                {{-- </li> --}}
                {{-- <li class="col-6 mt-4"> --}}
                  {{-- <a href="single-product.html" class="zoom-in overflow-hidden"
                    ><img src="{{asset('userside')}}/assets/img/mega-menu/2.png" alt="img"
                  /></a> --}}
                {{-- </li> --}}
              {{-- </ul> --}}
            </li>
            ...
            <li class="<?=$path=='contact'?'active':''?>"><a href="/contact">Contact Us</a></li>
            @if(session()->get('id') === null)
              <li><a href="/login_register">Log in / Register</a></li>
            @endif
          </ul>
        </div>
        <div class="col-6 col-lg-3">
              ...
              <ul class="d-flex">
                ...
                <li>
                  <a  href="/wishlist">
                    <span class="position-relative">
                      ...
                      <span class="badge cbdg1">{{$wishlist}}</span>
                    </span>
                  </a>
                </li>
                <li class="mr-xl-0 cart-block position-relative">
                  <a href="/cart">
                    <span class="position-relative">
                      <i class="icon-bag"></i>
                      <span class="badge cbdg1">{{$order}}</span>
                    </span>
                  </a>
                </li>
                @if(session()->get('id') !== null)
                  <li class="active ml-0">
                    <a href="/logout" class="ps-0 text-danger"
                      >Logout </a>
                    {{-- <ul class="sub-menu">
                      <li><a href="index.html">Home 1</a></li>
                      <li><a href="index-2.html">Home 2</a></li>
